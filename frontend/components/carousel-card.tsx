...
const Card: React.FC<CardProps> = ({ imageUrl, title, description, url }) => {
  ...
  return (
    <div className="animate-[wiggle_1s_ease-in-out_infinite] flex flex-col gap-4 rounded border border-black/10 bg-white p-6 dark:border-white/20 dark:bg-gray-900 w-60 h-60">
